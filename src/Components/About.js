        ...
        <div>
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <a href="https://www.instagram.com/orelkakon/" target="_blank" rel="noreferrer" style={{ textDecoration: "none", fontSize: "33px", color: "#fff", paddingRight: '2px'  }}> <img src={instaLogo} alt="instaLogo" height="33px" /></a>
                    ...
                    <a href="https://il.linkedin.com/in/orel-kakon-323928218" target="_blank" rel="noreferrer" style={{ textDecoration: "none", fontSize: "33px", color: "#fff", paddingRight: '1px' }}> <img src={linkedinLogo} alt="linkedinLogo" height="36px" /></a>
                    <a href="https://github.com/orelkakon" target="_blank" rel="noreferrer" style={{ textDecoration: "none", fontSize: "28px", color: "#fff" }}> <img src={githubLogo} alt="githubLogo" height="36px" /></a>
                </div>
                <br/><br/><br/><br/><br/>
            </div>
        </div>
